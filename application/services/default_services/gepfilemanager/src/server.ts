...
class App {
    ...
    private DatabaseCredentials() {
        ...
        SCMconfig.SCMData( async result => {
            this.DB_Url = result.data.DB_URL_thenewharsih101_5948;
            let db_auth = result.data.DB_AUTH_thenewharsih101_5948;
            let db_coll = result.data.DB_COLL_thenewharsih101_5948;
